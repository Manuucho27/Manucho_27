...
<head>
    <meta charset="UTF-8">
    <title>Manucho 27 - Si responde mis stories</title>
...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="disfruto.html">Disfruto</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="vimos-madriz.html">Vimos Madriz</a></li>
                            <li><a class="dropdown-item active" aria-current="page" href="si-responde-mis-stories.html">Si responde mis stories</a></li>
    ...
    <div class="container mt-5">
        <h1>Si responde mis stories</h1>
        <p>Contenido de la canción Si responde mis stories.</p>
    </div>
