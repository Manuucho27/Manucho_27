...
<head>
    <meta charset="UTF-8">
    <title>Manucho 27 - Prisionero</title>
...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item active" aria-current="page" href="prisionero.html">Prisionero</a></li>
                            <li>
    ...
    <div class="container mt-5">
        <h1>Prisionero</h1>
        <p>Contenido de la canción Prisionero.</p>
    </div>
