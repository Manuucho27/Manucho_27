...
<head>
    <meta charset="UTF-8">
    <title>Manucho 27 - Una chica</title>
...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" aria-current="page" href="una-chica.html">Una chica</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
    ...
    <div class="container mt-5">
        <h1>Una chica</h1>
        <p>Contenido de la canción Una chica.</p>
    </div>
