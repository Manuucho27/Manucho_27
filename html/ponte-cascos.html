...
<head>
    <meta charset="UTF-8">
    <title>Manucho 27 - Ponte cascos</title>
...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" aria-current="page" href="ponte-cascos.html">Ponte cascos</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        <h1>Ponte cascos</h1>
        <p>Contenido de la canción Ponte cascos.</p>
    </div>
