...
<head>
    <meta charset="UTF-8">
    <title>Manucho 27 - Una vez allí</title>
...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" aria-current="page" href="una-vez-alli.html">Una vez allí</a></li>
    ...
    <div class="container mt-5">
        <h1>Una vez allí</h1>
        <p>Contenido de la canción Una vez allí.</p>
    </div>
